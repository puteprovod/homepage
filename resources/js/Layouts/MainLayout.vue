            ...
            <div class="flex flex-wrap items-center justify-between mx-auto">
                ...
                <div class="flex items-center md:order-2 relative">
                    ...
                    <div :class="isLangOpen ? 'block' : 'hidden'"
                         class="z-50 my-4 absolute top-1 right-5 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow flex-nowrap"
                        ...
                        <li>
                            ...
                            <div id="dropdownNavbar" :class="isProjectsOpen ? 'block' : 'hidden'" class="z-10 absolute top-12 left-14 font-normal bg-white divide-y divide-gray-100 rounded-lg border shadow-lg w-64">
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                                    ...
                                    <li>
                                        <a href="https://ska-khabarovsk.ru/" target="_blank" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Сайт болельщиков СКА</a>
                                    </li>
                                    <li>
                                        <a href="https://ska-khabarovsk.ru/" target="_blank" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Гостевая болельщиков СКА</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
