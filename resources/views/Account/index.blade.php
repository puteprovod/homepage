            ...
            <table class="table">
                ...
                @foreach($accounts as $account)
                    <tr class="align-middle @switch($account->category_id)
                     ...
                     @endswitch">
                        ...
                        <td>{{ $account->title }}</td>
                        <td class="text-end">
                            <input type="text" name="value[{{$account->id}}]" class="form-control-sm"
                                   style="text-align: right; font-weight: bold;" id="title"
                                   value="{{ $account->value }}" placeHolder="title"></td>
                ...
                <tr class="align-middle">
                    <td colspan="3">
                        ...
                        @endif</td>
                    <td colspan="2" style="text-align: right"><b>Общий баланс счетов:</b></td>
